...
- [Prebuilt iOS Core: Improved modularization of React Native's XCFrameworks](#prebuilt-ios-core-the-clang-vfs-overlay-is-gone)
- [Experimental Swift Package Manager support for iOS](#experimental-swift-package-manager-support-for-ios)
...
### Experimental Swift Package Manager support for iOS (Preview)
