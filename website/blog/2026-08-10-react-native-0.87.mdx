...
- [Experimental Swift Package Manager support for iOS](/blog/2026/08/10/react-native-0.87#experimental-swift-package-manager-support-for-ios)
- [Android Gradle Plugin (AGP) v9](/blog/2026/08/10/react-native-0.87#android-gradle-plugin-agp-v9)
