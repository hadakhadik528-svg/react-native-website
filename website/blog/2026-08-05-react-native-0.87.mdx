---
title: 'React Native 0.87 - Strict TypeScript API by Default, Swift Package Manager, AGP 9 Support'
authors: zeyap, huntie, chrfalch, cipolleschi, robhogan
...
- [Strict TypeScript API is now the default](#strict-typescript-api-is-now-the-default)
...
```
cd ios
npx react-native spm -- deintegrate // deintegrate will remove Cocoapods from your project
```
...
See RFC0994 for the full design and migration plan.
...
React Native 0.87 contains 256 commits from 73 contributors. Thanks for all your hard work!

We want to send a special thank you to those community members that shipped significant contributions in this release.

- Alex Hunt for work on Strict TypeScript API
- Christian Falch for adding the support for Swift Package Manager
- Rob Hogan for upgrading Metro
